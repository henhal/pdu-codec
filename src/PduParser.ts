...
export default class PduParser<T extends Dict = Dict> {
   ...
   * @param reader Word reader, or name of property to write value to
   */
   ...
   * @param reader Word array reader, or name of property to write values to
   */
  number<U extends Dict, B extends BitLength>(
      bits: B,
      count: number,
   ...
   * @param reader Byte reader, or name of property to write value to
   */
   ...
   * @param reader Byte array reader, or name of property to write values to
   */
  uint8<U extends Dict>(
      count: number,
   ...
   * @param reader Reader to convert string into record, or name of property to write value to
   * @param options Options
   ...
   */
  string<U extends Dict>(reader: ReaderOrPropertyName<string, U, T>, {
    lengthBits = 8,
    nullTerminate = false,
  }: {
   ...
   */
  hex<U extends Dict>(reader: ReaderOrPropertyName<string, U, T>, {
    lengthBits = 8,
    length,
  }: {
    lengthBits?: BitLength | 0;
